...
public abstract class AbstractStaffInfoVO implements Serializable,
	 ...
	 * 出生日期
	 */
	@Column(name="BIRTHDAY",length=19L,type=java.sql.Types.DATE,nullable=true)
	protected LocalDateTime birthday;
	
	/**
	 * 入职日期
	 */
	@Column(name="ENTRY_DATE",length=19L,type=java.sql.Types.DATE,nullable=false)
	protected LocalDateTime entryDate;
	
	/**
	 * 离职日期
	 */
	@Column(name="TERM_DATE",length=19L,type=java.sql.Types.DATE,nullable=true)
	protected LocalDateTime termDate;
	...
	/** minimal constructor */
	public AbstractStaffInfoVO(String staffId,String staffCode,String staffName,String organId,String sexType,LocalDateTime entryDate,String createBy,LocalDateTime createTime,String updateBy,LocalDateTime updateTime,Integer status)
	{
		this.staffId=staffId;
	...
	/** full constructor */
	public AbstractStaffInfoVO(String staffId,String staffCode,String staffName,String organId,String sexType,LocalDateTime birthday,LocalDateTime entryDate,LocalDateTime termDate,byte[] photo,String country,String censusRegister,String address,String email,String telNo,String post,String postGrade,String createBy,LocalDateTime createTime,String updateBy,LocalDateTime updateTime,Integer status)
	{
		this.staffId=staffId;
		this.staffCode=staffCode;
		this.staffName=staffName;
