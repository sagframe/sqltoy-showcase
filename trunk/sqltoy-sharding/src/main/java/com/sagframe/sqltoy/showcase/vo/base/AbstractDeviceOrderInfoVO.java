...
public abstract class AbstractDeviceOrderInfoVO implements Serializable,
	 ...
	 * 成交日期
	 */
	@Column(name="TRANS_DATE",length=19L,type=java.sql.Types.DATE,nullable=false)
	protected LocalDateTime transDate;
	
	/**
	 * 交货期限
	 */
	@Column(name="DELIVERY_TERM",length=19L,type=java.sql.Types.DATE,nullable=true)
	protected LocalDateTime deliveryTerm;
	...
	/** minimal constructor */
	public AbstractDeviceOrderInfoVO(String orderId,String deviceType,String psType,LocalDateTime transDate,String createBy,LocalDateTime createTime,String updateBy,LocalDateTime updateTime,Integer status)
	{
		this.orderId=orderId;
	 ...
	 */
	public void setDeliveryTerm(LocalDateTime deliveryTerm) {
		this.deliveryTerm=deliveryTerm;
	}
	 ...
	 */
	public LocalDateTime getDeliveryTerm() {
